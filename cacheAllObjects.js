...
var objectCallback = function(objectJson){
  ...
  // triplify
  var id= "http://data.metmuseum.org/objects#"+objectid;
  var whatProp = "http://data.metmuseum.org/rels#what";
  var trips = [];
  $(objectJson['What']).each(function(key, value){
    var what = "http://data.metmuseum.org/whats#"+encodeURIComponent(value);
...
/*
  ...
  if(objectJson['Who']){
    var whoProp = "http://data.metmuseum.org/rels#who";
    $(objectJson['Who']).each(function(key, value){
   //   var who = "http://data.metmuseum.org/who#"+encodeURIComponent(value);
    //  trips.push(triplify(id, whoProp, who));
    }); 
  }
*/

  var whereProp = "http://data.metmuseum.org/rels#where";
  $(objectJson['Where']).each(function(key, value){
    var what = "http://data.metmuseum.org/location#"+encodeURIComponent(value);
    trips.push(triplify(id, whereProp, what));
  });



  var relatedProp = "http://data.metmuseum.org/rels#related";
  $(objectJson['related-artworks']).each(function(key, value){
    var what = "http://data.metmuseum.org/objects#"+encodeURIComponent(value);
    trips.push(triplify(id, relatedProp, what));
  });

  if(objectJson['image']){
    var imageProp = "http://data.metmuseum.org/rels#image";
    trips.push(triplify(id, imageProp, objectJson['image']));
  }
...
var triplify = function(sub, pred, obj){
  var string = "";
  string += "<"+ sub + "> <" +  pred + "> <" + obj + "> . \n";
  console.log("**************************************");
  console.log(string);
...
var triplifyString = function(sub, pred, obj){
  var string = "";
  string += "<"+ sub + "> <" +  pred + ">  \"" + obj + "\" . \n";
  console.log("**************************************");
  console.log(string);
